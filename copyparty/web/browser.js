...
var Ls = {
  ...
  "tur": {
    ...
    "cols": {
      ...
      "pixfmt": "alt örnekleme / pik yapısı",
    ...
    "hks": [
      [
        "çeşitli",
        ["ESC", "çeşitli şeyleri kapat"],

        "dosya-yöneticisi",
        ["G", "liste / ızgara görünümünü değiştir"],
        ["T", "küçük resimler / simgeler görünümünü değiştir"],
        ["⇧ A/D", "küçük resim boyutunu değiştir"],
        ["ctrl-K", "seçilenleri sil"],
        ["ctrl-X", "seçimi panoya kes"],
        ["ctrl-C", "seçimi panoya kopyala"],
        ["ctrl-V", "buraya yapıştır (taşı/kopyala)"],
        ["Y", "seçilenleri indir"],
        ["F2", "seçilenleri yeniden adlandır"],

        "dosya-listesi-seçimi",
        ["Boşluk", "dosya seçimini aç/kapat"],
        ["↑/↓", "seçim imlecini hareket ettir"],
        ["Ctrl ↑/↓", "imleci ve görünüm alanını hareket ettir"],
        ["Shift ↑/↓", "önceki/sonraki dosyayı seç"],
        ["Ctrl-A", "tüm dosyaları / klasörleri seç"]
      ], [
        "navigasyon",
        ["B", "yol konumu / Navigasyon bölmesini aç/kapat"],
        ["I/K", "önceki/sonraki klasör"],
        ["M", "üst klasör (veya mevcut klasörü daralt)"],
        ["V", "navigasyon bölmesinde klasörleri / metin dosyalarını aç/kapat"],
        ["A/D", "navigasyon bölmesi boyutu"]
      ], [
        "ses-oynatıcı",
        ["J/L", "önceki/sonraki şarkı"],
        ["U/O", "10sn geri/ileri atla"],
        ["0..9", "%0..%90'a atla"],
        ["P", "oynat/duraklat (ayrıca başlatır)"],
        ["S", "oynayan şarkıyı seç"],
        ["Y", "şarkıyı indir"],
      ], [
        "resim-görüntüleyici",
        ...
        ["⇧ R", "saat yönünün tersine çevir"],
        ["S", "resim seç"],
        ["Y", "resim indir"],
      ], [
        "video-oynatıcı",
        ["U/O", "10sn geri/ileri atla"],
        ["P/K/Space", "oynat/durdur"],
        ["C", "sonrakine devam et"],
        ["V", "döngü"],
        ["M", "sessiz"],
        ["[ and ]", "döngü aralığını ayarla"],
      ], [
        "metin-dosyası-görüntüleyici",
        ["I/K", "önceki/sonraki dosya"],
        ["M", "metin dosyasını kapat"],
        ["E", "metin dosyasını düzenle"],
        ["S", "dosyayı seç (kesme/kopyalama/yeniden adlandırma için)"],
      ]
    ],
    ...
    "gou": 'üst klasör">yukarı',
    "gon": 'sonraki klasör">sonraki',
    "logout": "Çıkış yap ",
    "access": " erişim",
    "ot_close": "alt menüyü kapat",
    "ot_search": "Dosyaları niteliklere, yola / ada, müzik etiketlerine veya bunların herhangi bir kombinasyonuna göre ara$N$N&lt;code&gt;foo bar&lt;/code&gt; = hem «foo» hem de «bar» içermeli,$N&lt;code&gt;foo -bar&lt;/code&gt; = «foo» içermeli ama «bar» içermemeli,$N&lt;code&gt;^yana .opus$&lt;/code&gt; = «yana» ile başlamalı ve «opus» dosyası olmalı file$N&lt;code&gt;&quot;try unite&quot;&lt;/code&gt; = tam olarak «try unite» içermeli $N$tarih formatı iso-8601 şeklindedir, like$N&lt;code&gt;2009-12-31&lt;/code&gt; veya &lt;code&gt;2020-09-12 23:30:00&lt;/code&gt;",
    "ot_unpost": "unpost: son yüklemelerinizi silin veya tamamlanmamış olanları iptal edin",
    "ot_bup": "bup: temel yükleyici, hatta netscape 4.0'ı bile destekler",
    "ot_mkdir": "mkdir: yeni bir klasör/dizin oluştur",
    "ot_md": "new-md: yeni bir markdown belgesi oluştur",
    "ot_msg": "msg: sunucu günlüğüne (server log) bir mesaj gönder",
    "ot_mp": "medya oynatıcı seçenekleri",
    "ot_cfg": "yapılandırma seçenekleri",
    "ot_u2i": 'up2k: upload files (if you have write-access) or toggle into the search-mode to see if they exist somewhere on the server$N$Nuploads are resumable, multithreaded, and file timestamps are preserved, but it uses more CPU than [🎈]&nbsp; (the basic uploader)<br /><br />during uploads, this icon becomes a progress indicator!',
    "ot_u2w": 'up2k: upload files with resume support (close your browser and drop the same files in later)$N$Nmultithreaded, and file timestamps are preserved, but it uses more CPU than [🎈]&nbsp; (the basic uploader)<br /><br />during uploads, this icon becomes a progress indicator!',
    "ot_noie": 'Please use Chrome / Firefox / Edge',

    "ab_mkdir": "klasör/dizin oluştur",
    "ab_mkdoc": "yeni markdown dokümanı",
    "ab_msg": "srv günlüğüne (srv log) msg gönder",

    "ay_path": "klasörlere atla",
    "ay_files": "dosyalara atla",

    "wt_ren": "seçili öğeleri yeniden adlandır$NHotkey: F2",
    "wt_del": "seçili öğeleri sil$NHotkey: ctrl-K",
    "wt_cut": "seçili öğeleri kes$N&lt;small&gt;(sonra başka bir yere yapıştır)&lt;/small&gt;$NHotkey: ctrl-X",
    "wt_cpy": "seçili öğeleri panoya kopyala$N(sonra başka bir yere yapıştırmak için)$NHotkey: ctrl-C",
    "wt_pst": "daha önce kesilmiş / kopyalanmış bir seçimi yapıştır$NHotkey: ctrl-V",
    "wt_selall": "tüm dosyaları seç$NHotkey: ctrl-A (dosyaya odaklıyken)",
    "wt_selinv": "seçimi terse çevir",
    "wt_zip1": "bu klasörü arşiv olarak indir",
    ...
    "wt_m3ua": "m3u çalma listesine ekle (sonra <code>📻kopyala</code>'ya tıklayın)",
    ...
    "ut_rand": "rastgele dosya isimlendirme",
    "ut_u2ts": "son değiştirilen zaman damgasını$Ndosya sisteminizden sunucuya kopyalayın\">📅",
    "ut_ow": "sunucudaki mevcut dosyaları üzerine yaz?$N🛡️: asla (yerine yeni bir dosya adı oluşturacak)$N🕒: sunucu dosyası sizinkinden daha eskiyse üzerine yaz$N♻️: dosyalar farklıysa her zaman üzerine yaz",
    "ut_mt": "yükleme sırasında diğer dosyaların hash'ini hesaplamaya devam et$N$NEğer CPU veya HDD zorlanıyorsa devre dışı bırakın",
    "ut_ask": 'yükleme başlamadan önce onay iste">💭',
    "ut_pot": "Arayüzünü daha az karmışık yaparak$Nyavaş cihazlarda yükleme hızını artır",
    "ut_srch": "Yükleme yapmayın, bunun yerine dosyalarının sunucuda var olup $N olmadığını  kontrol edin (okuma izninizin olduğu tüm klasörleri tarayacaktır)",
    "ut_par": "0'a ayarlıyarak yüklemeleri durdurun$N$NBağlantınız yavaşsa / yüksek gecikme süresine sahipse artırın$N$NHDD zorlanıyor veya LAN'da iseniz 1'e sabitleyin",
    "ul_btn": "dosyaları / klasörleri<br>buraya bırakın (veya bana tıklayın)",
    "ul_btnu": "Y Ü K L E",
    "ul_btns": "A R A",

    "ul_hash": "hash",
    "ul_send": "gönder",
    "ul_done": "done", // ? Is that a functional term here? or just a label?
    "ul_idle1": "henüz bekleyen bir yükleme yok",
    "ut_etah": "ortalama &lt;em&gt;hashing&lt;/em&gt; hızı, ve bitişene kalan tahmini süre",
    "ut_etau": "ortalama &lt;em&gt;yükleme&lt;/em&gt; hızı, ve bitişene kalan tahmini süre",
    "ut_etat": "ortalama &lt;em&gt;toplam&lt;/em&gt; hızı, ve bitişene kalan tahmini süre",

    "uct_ok": "completed successfully", // ? Need context here
    "uct_ng": "no-good: başarısız / reddedildi / bulunamadı", // ? same
    "uct_done": "ok and ng combined", // ? same
    "uct_bz": "hashleniyor veya yükleniyor",
    "uct_q": "boşta, beklemede",
    ...
    "utl_404": "404",
    "utl_err": "HATA",
    "utl_oserr": "İşletim Sistemi Hatası",
    "utl_found": "bulundu",
    "utl_defer": "ertele",
    "utl_yolo": "YOLO",
    "utl_done": "tamamlandı",
    ...
    "lang_set": "dil değişimi için sayfayı yenile?",
  },
	"ukr": {
		"tt": "Українська",
...
var LANGS = ["eng", "nor", "nno", "chi", "cze", "deu", "fin", "fra", "grc", "ita", "nld", "rus", "spa", "tur", "ukr"];
